...
class LPApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.add_variable_button = self.createStyledButton("Ajouter Variable", self.add_variable, color="#008CBA")
        ...
        self.add_constraint_button = self.createStyledButton("Ajouter Contrainte", self.add_constraint_row, color="#008CBA")
        ...
        # Solve Button
        self.solve_button = self.createStyledButton("Résoudre", self.solve_lp, color="#4CAF50")
        ...
        self.result_output.setStyleSheet(
            "color: #FFFFFF; background-color: #2E2E2E; border: 2px solid #808080; border-radius: 5px; padding: 10px;")
    ...
    def createStyledLabel(self, text, font_size):
        ...
        label.setStyleSheet(f"color: #FFD700; font-family: 'Trebuchet MS'; font-size: {font_size}px; font-weight: bold;")
    ...
    def createStyledLineEdit(self):
        ...
        line_edit.setStyleSheet(
            "color: #FFFFFF; background-color: #2E2E2E; border: 2px solid #808080; border-radius: 5px; padding: 5px;")
        line_edit.setFont(QFont("Trebuchet MS", 14, QFont.Bold))
        return line_edit

    def createStyledButton(self, text, callback, color):
        darker_color = self.adjust_color_brightness(color, -40)
        even_darker_color = self.adjust_color_brightness(color, -80)
    ...
    def update_variables_display(self):
        ...
        for name, coef in zip(self.variable_names, self.coefficients):
            ...
            label.setStyleSheet("color: #FFFFFF; font-family: 'Trebuchet MS'; font-size: 14px; font-weight: bold;")
